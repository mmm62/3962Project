...
INSERT INTO `admin` (`ID`, `Priority`) VALUES
('1234', 2);
...
INSERT INTO `sensor` (`ID`, `Location`, `type`) VALUES
('1', 'inter1', 'Light');
...
--
-- 转存表中的数据 `trafficlight`
--

INSERT INTO `trafficlight` (`state`, `countdown`, `intersectionID`) VALUES
('RED', 20, 'inter1');
...
INSERT INTO `vehicle` (`speed`, `position`, `Carplate`) VALUES
(20, 'inter1', 'dd222');
